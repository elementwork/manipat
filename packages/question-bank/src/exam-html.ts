...
const answerSheet = (questions: readonly AnyPatQuestion[]): string => {
  ...
  const singlePageClass = questions.length <= 90 ? " answer-sheet-single-page" : "";
  return `<section class="exam-page answer-sheet${singlePageClass}"><header class="section-header"><div><strong>Answer Sheet</strong><span>Mark one answer for each question.</span></div></header><div class="answer-grid">${items}</div></section>`;
};
...
const style = String.raw`<style>
  ...
  @page{size:letter portrait;margin:0}@media print{html,body{background:#fff}.exam{margin:0;max-width:none}.exam-page{break-after:page;box-shadow:none;margin:0;min-height:11in;page-break-after:always;padding:.28in;width:8.5in}.exam-page:last-child{break-after:auto;page-break-after:auto}.exam-question,.cube-figure-group{break-inside:avoid;page-break-inside:avoid}.answer-sheet-single-page{break-inside:avoid;page-break-inside:avoid;height:11in;min-height:11in;max-height:11in;overflow:hidden}.answer-sheet-single-page .answer-grid{gap:.025in .16in;padding-top:.04in}.answer-sheet-single-page .answer-item{font-size:7.8pt;min-height:.2in}}
